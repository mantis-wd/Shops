      ...
      if ( ($_POST['back_x']) || ($_POST['back_y']) ) {
        ...
        if ($_GET['oldaction']=='voucheredit') {
          ...
          for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
            ...
            $update = xtc_db_query("UPDATE " . TABLE_COUPONS_DESCRIPTION . " 
                                       SET coupon_name = '" . xtc_db_prepare_input($_POST['coupon_name'][$language_id]) . "',
                                           coupon_description = '" . xtc_db_prepare_input($_POST['coupon_desc'][$language_id]) . "'
          ...
          //BOF - DokuMan - 2011-07-07 - fix bug to prevent errors when adding a new voucher. This will also fix when there is no name or description in final voucher
          //$insert_id = xtc_db_insert_id($query);
          $insert_id = xtc_db_insert_id();
          //EOF - DokuMan - 2011-07-07 - fix bug to prevent errors when adding a new voucher. This will also fix when there is no name or description in final voucher
...
require (DIR_WS_INCLUDES.'head.php');
  ...
  if (USE_WYSIWYG=='true' && $action == 'email') {
        ...
        <?php
          switch ($action) {
                ...
                <table border="0" width="100%" cellspacing="0" cellpadding="2">
                  ...
                  <tr>
                    <?php echo xtc_draw_form('mail', FILENAME_COUPON_ADMIN, 'action=preview_email&cid='. (int)$_GET['cid']); ?>
                      <td>
                        <table width="70%" class="main" border="0" cellpadding="0" cellspacing="2">
                          <?php // web28 - 2010-07-23 - new table design ?>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td><?php echo xtc_draw_pull_down_menu('customers_email_address', $customers, isset($_GET['customer'])?$_GET['customer']:'', 'style="width: 292px"');?></td>
                          </tr>
                          <tr>
                            <td colspan="2"><?php echo xtc_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
                          </tr>
                          <tr>
                            ...
                            <td><?php echo xtc_draw_input_field('from', EMAIL_FROM, 'style="width: 292px"'); ?></td>
                          </tr>
                          <tr>
                            <td colspan="2"><?php echo xtc_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
                          </tr>
                          ...
                          */
                          ...
                          <tr>
                            ...
                            <td><?php echo xtc_draw_input_field('subject',isset($_POST['subject'])?$_POST['subject']:'', 'style="width: 292px"'); ?></td>
                          </tr>
                          <tr>
                            <td colspan="2"><?php echo xtc_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
                          </tr>
                          <tr>
                            ...
                            <td><?php echo xtc_draw_textarea_field('message', 'soft', '60', '15', isset($_POST['message'])?$_POST['message']:''); ?></td>
                          </tr>
                          <tr>
                            <td colspan="2"><?php echo xtc_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
                          </tr>
                          <tr>
                            <td colspan="2" align="center"><?php echo '<input type="submit" class="button" onclick="this.blur();" value="' . BUTTON_SEND_EMAIL . '"/>'; ?></td>
                          </tr>
                        </table>
                      </td>
                    </form>
            ...
            case 'new':
              ...
              if (isset($_POST['coupon_uses_coupon'])) 
                $coupon_uses_coupon = $_POST['coupon_uses_coupon'];
              if (isset($_POST['coupon_uses_user'])) 
                $coupon_uses_user = $_POST['coupon_uses_user'];
              if (isset($_POST['coupon_products'])) 
                $coupon_products = $_POST['coupon_products'];
              if (isset($_POST['coupon_categories'])) 
                $coupon_categories = $_POST['coupon_categories'];
              if (isset($_POST['coupon_startdate_day'])) 
                $coupon_start_date = date('Y-m-d', mktime(0, 0, 0, $_POST['coupon_startdate_month'],$_POST['coupon_startdate_day'] ,$_POST['coupon_startdate_year']));
              if (isset($_POST['coupon_finishdate_day'])) 
                $coupon_expire_date = date('Y-m-d', mktime(0, 0, 0, $_POST['coupon_finishdate_month'],$_POST['coupon_finishdate_day'] ,$_POST['coupon_finishdate_year']));
                            ...
                            <table border="0" width="100%" cellspacing="0" cellpadding="2">
                              ...
                              if ($status != '*') {
                                $cc_query_raw = "SELECT coupon_id, 
                                                        ...
                                                        date_modified 
                                                   FROM " . TABLE_COUPONS ." 
                                                  WHERE coupon_active='" . xtc_db_input($status) . "' 
                                                    AND coupon_type != 'G' 
                                               ORDER BY date_created DESC"; //DokuMan added 'ORDER BY date_created DESC'
                              } else {
                                $cc_query_raw = "SELECT coupon_id, 
                                                        coupon_code, 
                                                        coupon_amount, 
                              ...
                              while ($cc_list = xtc_db_fetch_array($cc_query)) {
                                ...
                                if (isset($cInfo) && is_object($cInfo) && ($cc_list['coupon_id'] == $cInfo->coupon_id) ) {
                                  ...
                                  $coupon_description_query = xtc_db_query("SELECT coupon_name 
                                                                             ...
                                                                             WHERE coupon_id = '" . (int)$cc_list['coupon_id'] . "' 
