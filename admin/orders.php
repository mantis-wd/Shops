...
<?php require (DIR_WS_INCLUDES.'header.php'); ?>
  <table border="0" width="100%" cellspacing="2" cellpadding="2">
    <tr>
      <td class="columnLeft2 columnLeft" width="<?php echo BOX_WIDTH; ?>" valign="top">
                  ...
                  <?php
                      ...
                      switch ($action) {
                        case 'delete' :
                          ...
                          $contents[] = array ('align' => 'center', 'text' => '<br /><input type="submit" class="button" value="'. BUTTON_DELETE_OR_REVERSE .'"><a class="button" href="'.xtc_href_link(FILENAME_ORDERS, xtc_get_all_get_params(array ('oID', 'action')).'oID='.$oInfo->orders_id).'">' . BUTTON_CANCEL . '</a>');
                          break;
                        default :
                      ...
                      if (xtc_not_null($heading) && xtc_not_null($contents)) {
                        echo '                  <td width="25%" valign="top">'.box::infoBoxSt($heading, $contents).'</td>';
                      }
                      ?>
                </tr>
              </table>
