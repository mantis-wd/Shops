<?php
  /* --------------------------------------------------------------
   $Id: accounting.php 4200 2013-01-10 19:47:11Z Tomcraft1980 $
   ...
   (c) 2006 xt-commerce (accounting.php 1167 2005-08-22); www.xt-commerce.com
            ...
            <tr>
              <td colspan="2" class="main">
                ...
                <table width="100%" cellpadding="0" cellspacing="2">
                  <tr>
                    <td style="border: 1px solid; border-color: #000000;" width="10" bgcolor="FF6969" >
                      <?php echo xtc_draw_separator('pixel_trans.gif',15, 15); ?>
                    </td>
                  ...
                  <tr>
                    <td style="border: 1px solid; border-color: #000000;" width="10" bgcolor="69CDFF" >
                      <?php echo xtc_draw_separator('pixel_trans.gif',10, 15); ?>
                    </td>
                    <td width="100%" class="main">
                      <?php echo TXT_CUSTOMERS; ?>
                    </td>
                  </tr>
                  <tr>
                    <td style="border: 1px solid; border-color: #000000;" width="10" bgcolor="6BFF7F" >
                      <?php echo xtc_draw_separator('pixel_trans.gif',15, 15); ?>
                    </td>
                    <td width="100%" class="main">
                      <?php echo TXT_PRODUCTS; ?>
                    </td>
                  </tr>
                  <tr>
                    <td style="border: 1px solid; border-color: #000000;" width="10" bgcolor="BFA8FF" >
                      <?php echo xtc_draw_separator('pixel_trans.gif',15, 15); ?>
                    </td>
                    <td width="100%" class="main">
                      <?php echo TXT_STATISTICS; ?>
                    </td>
                  </tr>
                  <tr>
                    <td style="border: 1px solid; border-color: #000000;" width="10" bgcolor="FFE6A8" >
                      <?php echo xtc_draw_separator('pixel_trans.gif',15, 15); ?>
                    </td>
                    <td width="100%" class="main">
                      <?php echo TXT_TOOLS; ?>
                ...
                <br />
                <!-- BOF - web28 - 2010.05.30 - set all checkboxes -->
                <a class="button" href="#" onclick="set_checkbox(1);">
                  <?php echo BUTTON_SET; ?>
                </a>
                <a class="button" href="#" onclick="set_checkbox(0);">
                  <?php echo BUTTON_UNSET; ?>
                </a>
                <br /><br />
                <!-- EOF - web28 - 2010.05.30 - set all checkboxes -->
              </td>
