<?php
/* -----------------------------------------------------------------------------------------
   $Id: google_sitemap.php 4200 2013-01-10 19:47:11Z Tomcraft1980 $
...
define('MAX_SIZE', 10000000); // 10 MB would be 10,485,760 Bytes - stay below that value
...
function output_entry() {
    ...
    $c++;
    if ($autogenerate) {
        // 50000 entrys or filesize > 10,485,760 - some space for the last entry
