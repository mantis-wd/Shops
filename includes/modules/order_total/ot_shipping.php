<?php
/* -----------------------------------------------------------------------------------------
   $Id: ot_shipping.php 4200 2013-01-10 19:47:11Z Tomcraft1980 $
    ...
    function process() {
      ...
      if (xtc_not_null($order->info['shipping_method'])) {
        ...
        // price with tax
          ...
          if (!isset($order->info['tax_groups'][TAX_ADD_TAX . $shipping_tax_description .TAX_SHORT_DISPLAY])) {
            $order->info['tax_groups'][TAX_ADD_TAX . $shipping_tax_description .TAX_SHORT_DISPLAY] = 0;
          }
          ...
          if ($_SESSION['customers_status']['customers_status_show_price_tax'] == 0 && $_SESSION['customers_status']['customers_status_add_tax_ot'] == 1) {
            ...
            //BOF - DokuMan - 2010-09-06 - set correct order of VAT display, added .TAX_SHORT_DISPLAY
            if (!isset($order->info['tax_groups'][TAX_NO_TAX . $shipping_tax_description .TAX_SHORT_DISPLAY])) {
