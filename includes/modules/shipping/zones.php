 ...
 */
/*##################################*/ 
 define('NUM_ZONES_MODULE_ZONES', 9); 
/*##################################*/
 ...
 */
    function zones() {
      ...
      $this->num_zones = NUM_ZONES_MODULE_ZONES;
    }
 ...
 */
    ...
    function install() {
      ...
      //BOF - web28 - 2011-06-13 - set default values only for zone 1
      for ($i = 1; $i <= $this->num_zones; $i++) {
        $default_countries = '';
        $default_zone_cost = '';
        if ($i == 1) {
          $default_countries = 'DE';
          $default_zone_cost = '3:8.50,7:10.50,99:20.00';
        }
        xtc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value, configuration_group_id, sort_order, set_function, date_added) values ('MODULE_SHIPPING_ZONES_COUNTRIES_" . $i ."', '" . $default_countries . "', '6', '0', 'xtc_cfg_textarea(', now())"); //web28 -2011-06-13 - support for textareas
        xtc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value, configuration_group_id, sort_order, date_added) values ('MODULE_SHIPPING_ZONES_COST_" . $i ."', '" . $default_zone_cost . "', '6', '0', now())");
      ...
      //EOF - web28 - 2011-06-13 - set default values only for zone 1
    }
