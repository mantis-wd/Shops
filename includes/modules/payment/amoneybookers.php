...
/* -----------------------------------------------------------------------------------------
   ...
   (c) 2006 XT-Commerce (amoneybookers.php 150 2007-01-24)
...
class amoneybookers {
  ...
  function __construct() {
    ...
    $this->tmpOrders = true;
    $this->tmpStatus = defined('MODULE_PAYMENT_AMONEYBOOKERS_TMP_STATUS_ID')?MODULE_PAYMENT_AMONEYBOOKERS_TMP_STATUS_ID:'';
    ...
    if (defined('MODULE_PAYMENT_AMONEYBOOKERS_ORDER_STATUS_ID')) {
  ...
  function selection() {
    ...
    $content = array_merge($content, array (array ('title' => xtc_image(DIR_WS_ICONS . 'arrow_accepted.jpg'),
  ...
  function install() {
    ...
    xtc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value,  configuration_group_id, sort_order, date_added) values ('MODULE_PAYMENT_AMONEYBOOKERS_NEG_SHIPPING', '', '6', '99', now())");
  }
  ...
  function keys() {
    return array ('MODULE_PAYMENT_AMONEYBOOKERS_STATUS',
                  ...
                  'MODULE_PAYMENT_AMONEYBOOKERS_NEG_SHIPPING'
                 );
  }
