 ...
 ***********************************************************************************
 *
 * $Id: pn_sofortueberweisung.php 4307 2013-01-14 07:38:50Z Tomcraft1980 $
 *
 */
...
class pn_sofortueberweisung {
  ...
  // EOF - Hendrik - 2010-08-11 - php5 compatible
    ...
    $this->sort_order = defined('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_SORT_ORDER')?MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_SORT_ORDER:'';
    $this->enabled = ((defined('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_STATUS') && MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_STATUS == 'True') ? true : false);
    $this->info = MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TEXT_INFO;
    $this->tmpOrders = true;
    $this->tmpStatus = defined('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TMP_STATUS_ID')?MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TMP_STATUS_ID:'';
    if (defined('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_ORDER_STATUS_ID') && (int) MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_ORDER_STATUS_ID > 0) {
  ...
  function install () {
    ...
    if (isset($_GET['autoinstall']) && ($_GET['autoinstall'] == '1')) {
      ...
      if (defined('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_STATUS') && (MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_STATUS == 'True')) {
        xtc_redirect(xtc_href_link_admin(DIR_WS_ADMIN . 'modules.php', 'set=payment&module=pn_sofortueberweisung', 'SSL'));
      }
