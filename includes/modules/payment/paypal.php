...
/**************************************************************/
  ...
  // EOF - Hendrik - 2010-08-11 - php5 compatible
    ...
    /*
    if(defined('MODULE_PAYMENT_PAYPAL_SORT_ORDER') && MODULE_PAYMENT_PAYPAL_SORT_ORDER!=''){
...
/**************************************************************/
  function install() {
    ...
    // BOF - Hendrik - 2010-08-11 - exlusion config for shipping modules
    xtc_db_query("insert into ".TABLE_CONFIGURATION.$m_fields."values ('MODULE_PAYMENT_PAYPAL_NEG_SHIPPING', '', '6', '99', NULL, now(), '', '')");
    // EOF - Hendrik - 2010-08-11 - exlusion config for shipping modules
