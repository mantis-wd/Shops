...
//      $_SESSION['bs_article'] = $article;
  ...
  function install() {
    ...
    $check_query = xtc_db_query('SHOW COLUMNS FROM '.TABLE_CONFIGURATION.' like "MODULE_PAYMENT_BILLSAFE_2HP_NEG_SHIPPING"');
    if (xtc_db_num_rows($check_query) == 0) xtc_db_query('INSERT INTO '.TABLE_CONFIGURATION.' (configuration_key, configuration_value, configuration_group_id, sort_order, date_added) VALUES ("MODULE_PAYMENT_BILLSAFE_2HP_NEG_SHIPPING", "", "6", "99", now())');
  }
