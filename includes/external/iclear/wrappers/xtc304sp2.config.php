...
$Id: xtc304sp2.config.php 3868 2012-11-08 16:30:39Z Tomcraft1980 $
...
if(!defined('DIR_WS_CATALOG')) {
  ...
  //20100818 CA added support for newer smarty version (used by commerce:SEO for example)
  if (file_exists(DIR_WS_CLASSES.'Smarty_2.6.14/Smarty.class.php'))
  require_once (DIR_WS_CLASSES.'Smarty_2.6.14/Smarty.class.php');
  else if (file_exists(DIR_WS_CLASSES.'Smarty_2.6.26/Smarty.class.php'))
  ...
  //20110309 CA added fix for ot_coupon
  if (file_exists(DIR_FS_INC.'xtc_get_tax_rate_from_desc.inc.php'))
...
define(IC_LABEL . 'TEXT_TITLE', $lang->getParam('MODULE_TITLE'));
