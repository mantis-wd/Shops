<?php
/* -----------------------------------------------------------------------------------------
   $Id: class.moneybookers.php 4200 2013-01-10 19:47:11Z Tomcraft1980 $
...
//    $process_button_string =
  ...
  function install() {
    ...
    // BOF - Hendrik - 2010-08-11 - exlusion config for shipping modules
    xtc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value,  configuration_group_id, sort_order, date_added) values ('MODULE_PAYMENT_MONEYBOOKERS_".strtoupper($this->module)."_NEG_SHIPPING', '', '6', '99', now())");
    // EOF - Hendrik - 2010-08-11 - exlusion config for shipping modules
