...
class PHPMailer {
   ...
   * @var string
   */
  public $CharSet           = 'utf-8'; // 'iso-8859-1'; //DokuMan - change phpmailer defaults
 ...
 */
  ...
  * @access public
  */
  function SetLanguage($langcode = 'en', $lang_path = '') { //DokuMan - change phpmailer defaults
  ...
  */
  ...
  protected function Lang($key) {
    if(count($this->language) < 1) {
      $this->SetLanguage('de'); // set the default language //DokuMan - change phpmailer defaults
    }
