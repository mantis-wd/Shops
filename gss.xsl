        ...
        <script language="JavaScript">
          <![CDATA[
                ...
                for(c=0;c<theTab.rows[r].cells.length;c++, colNum++){
                  if(theTab.rows[r].cells[c].colSpan<2){
                    ...
                    if(rTitle>""){
                      ...
                      if(numeric.indexOf("."+colNum+".")>-1)
                        sortParams -= 1;
                      if(desc.indexOf("."+colNum+".")>-1)
                        sortParams -= 2;
                      if(html.indexOf("."+colNum+".")>-1)
                        sortParams -= 4;
                      if(freq.indexOf("."+colNum+".")>-1)
                        sortParams -= 8;
            ...
            function sortTable(theCell, colNum, hdrRows, sortParams){
              ...
              if(tBody.rows[0].sCol==colNum)
                sDir = !tBody.rows[0].sDir;
