<?php
/* -----------------------------------------------------------------------------------------
   $Id: xtc_get_manufacturers.inc.php 4200 2013-01-10 19:47:11Z Tomcraft1980 $
   ...
   (c) 2003 XT-Commerce (xtc_get_manufacturers.inc.php 899 2005-04-29 02)
  ...
  function xtc_get_manufacturers($manufacturers_array = '') {
    ...
    if (isset ($manufacturers_cache) && $manufacturers_array == '')
