...
define('MODULE_PAYMENT_ICLEAR_CREDITCARD_NEG_SHIPPING_TITLE', 'Exclusion in case of shipping');
define('MODULE_PAYMENT_ICLEAR_CREDITCARD_NEG_SHIPPING_DESC', 'deactivate this payment if one of these shippingtypes are selected (list separated by comma)');
